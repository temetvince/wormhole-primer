...
- `.gitignore`: A `.gitignore` file to exclude unnecessary files from the
...
This project is released under the Unlicense. This means it is placed in the
public domain and you are free to use, modify, and distribute the work without
any restrictions. For more details, see the `LICENSE` file.
